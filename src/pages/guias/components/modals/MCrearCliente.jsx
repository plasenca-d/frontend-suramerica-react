...
export const MCrearCliente = ({ isOpen, onClose, setLabel, setClient }) => {
    ...
    const create = () => {
        ...
        if (!tipoDocumento, !pais, !nombre, !apellido, !documento, !ciudad, !estado, !correo, !telefono) {
            toast({
                title: 'Error.',
        ...
        let empresa = Cookies.get("empresaId")
        const payload = {
            tipoDocumento,
            pais,
            nombre,
        ...
        instanceWithToken.post('clientes', payload).then((result) => {
            toast({
                title: 'Registrado.',
